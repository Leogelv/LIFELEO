  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <motion.div
          className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-gradient-to-br from-cyan-300/20 to-blue-300/20 dark:from-cyan-500/10 dark:to-blue-500/10 blur-3xl"
          animate={{
            x: [100, -100, 100],
            y: [100, -100, 100],
            scale: [1.1, 1, 1.1],
